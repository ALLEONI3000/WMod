...
[hashtable]$equivalents = @{
   "HKEY_CLASSES_ROOT"                                 = "HKEY_LOCAL_MACHINE\AL_SOFTWARE\Classes"
   "HKEY_LOCAL_MACHINE\\SOFTWARE"                      = "HKEY_LOCAL_MACHINE\AL_SOFTWARE"
   "HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet"     = "HKEY_LOCAL_MACHINE\AL_SYSTEM\ControlSet001"
   "HKEY_LOCAL_MACHINE\\SYSTEM\\ControlSet\d\d\d"      = "HKEY_LOCAL_MACHINE\AL_SYSTEM\ControlSet001"
   "HKEY_LOCAL_MACHINE\\SYSTEM"                        = "HKEY_LOCAL_MACHINE\AL_SYSTEM"
   "HKEY_USERS\\\.DEFAULT"                             = "HKEY_LOCAL_MACHINE\AL_DEFAULT"
   "HKEY_CURRENT_USER"                                 = "HKEY_LOCAL_MACHINE\AL_NTUSER"
   "HKEY_LOCAL_MACHINE\\AL_SYSTEM\\CurrentControlSet"  = "HKEY_LOCAL_MACHINE\AL_SYSTEM\ControlSet001"
   "HKEY_LOCAL_MACHINE\\AL_SYSTEM\\ControlSet\d\d\d"   = "HKEY_LOCAL_MACHINE\AL_SYSTEM\ControlSet001"
}
